// =============================================================================
// POPCORN GPS COLLAR V6.0 - WEB DASHBOARD
// =============================================================================
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            ...
            <main className="container mx-auto px-4 py-6">
                ...
                {activeTab === 'walks' && (
                    <WalksView walkHistory={walkHistory} />
                )}
            </main>
        </div>
    );
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">v6.0</p>
                        </div>
                    </div>
...
function WalksView({ walkHistory }) {
    const totalDistance = walkHistory.reduce((sum, w) => sum + (w.distance_meters || 0), 0);
    const avgScore = walkHistory.filter(w => w.grade_score).length > 0
        ? walkHistory.reduce((sum, w) => sum + (w.grade_score || 0), 0) / walkHistory.filter(w => w.grade_score).length
        : 0;
                    ...
                    {walkHistory.map((walk, i) => (
                        <div key={i} className="flex items-center justify-between p-4 bg-gray-700/50 rounded">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-gray-500 text-xs">{walk.grade_score || '-'}/100</p>
                            </div>
                        </div>
                    ))}
